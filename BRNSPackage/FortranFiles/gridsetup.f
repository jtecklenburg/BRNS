...
c            x(j) = x(j-2) + 9.d0
c          end if
           if (x(j-2).lt.50.0d0) then
                x(j)=x(j-2)+2d0/2.0
           else if (x(j-2).lt.240.0d0) then
                x(j)=x(j-2)+5.0d0/2.0
           else if (x(j-2).lt.1000.0d0) then
                x(j)=x(j-2)+20.0d0/2.0
           else if (x(j-2).lt.5000.0d0) then
                x(j)=x(j-2)+50.0d0/2.0
           else
                x(j)=x(j-2)+100.0d0/2.0
           end if
