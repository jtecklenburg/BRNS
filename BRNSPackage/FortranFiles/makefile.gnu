...
brns: advdiffcoeff.o basic.o biogeo.o boundaries.o diagenesis.o \
	drivervalues.o eigen.o frngdb.o gaussj.o getdelt.o \
	gridsetup.o initialcond.o issolid.o jacobian.o limits.o \
	LUBKSB.o LUDCMP.o main.o molecular.o MPROVE.o NEWT.o newtonsub.o\
	notransport.o output.o porarea.o printdepth.o rates.o residual.o \
	ssrates.o steadystate.o switches.o \
	timestep.o transcoeff-MT.o transcoeff.o transport.o TRIDAG.o printsvnversion_nosvn.o
