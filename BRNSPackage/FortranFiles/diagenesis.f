...
999       nt = nt+1
        time = time + delt
c        call boundaries() ! AquaDiva time dependent BC update
c        if (time.lt.365.0) spb(3,1) = 625.D0*3.0 ! AquaDiva time dependent BC update
c        spb(3,1) = 625.D0*(1.+sin(time/365.0*2*3.1415927410125732)) ! AquaDiva time dependent BC update
c       write(*,*) time, delt
